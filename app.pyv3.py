...
<style>
    ...
    .stTabs [data-baseweb="tab"] { color: rgba(255,255,255,0.7) !important; font-weight: 600 !important; font-size: 0.9rem !important; padding: 0.6rem 1.2rem !important; border-radius: 8px !important; background-color: transparent !important; }
    ...
    .main-header p { color: #B0C4DE !important; }
...
IMPORTANT: All dollar amounts as numbers. All percentages as decimals (95%=0.95). SWOT and transparency = YOUR expert assessment. Return ONLY JSON."""
